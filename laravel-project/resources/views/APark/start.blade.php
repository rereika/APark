        ...
        <div class="whats_good_idea_section" id="whats_good_idea_section">
            ...
            <div class="whats_good_idea_section1">
                ...
                <div class="whats_good_idea_message">
                    ...
                    <p class="whats_good_idea">　初めまして！APPRENTICE 5期生の大嶽です。<br>早速ですが、皆さんはチーム開発やオリジナルプロダクトにおいて、<span class="bold">良いアイデア</span>に出会えていますか？<br>このアプリは、私自身が<span class="bold">良いアイデア</span>に悩んだ私の実体験から生まれました。<br><br>　APPRENTICE生のような開発未経験者にとって、、突然「良いアイデアを出しましょう！」と言われても、すぐに思いつくのは難しく、苦労することが多いと言われています。<br>　それは、「良いアイデア」を出すには、<span class="red">単なるひらめきだけでなくさまざまな要素を考慮しなければならない</span>からです。既存のアプリとの差別化や実現可能性、さらにはモチベーションを維持するための工夫など、多面的な視点が求められます。実際に私も「右も左もわからないのに最初（アイデア出し）でつまずいたら終わり！？」という不安に悩まされました。<br><br>　この経験から、アイデアを分析・可視化し、フィードバックをもらいつつ、先輩や後輩のアイデアも参考にできる場を提供したいと考え、このアプリを開発しました。<br><br>　アイデア出しでつまずくと先に進めず、楽しくない開発はストレスとなり、ユーザーがつかないアイデアはドラフト指名を得られません。<br>　AParkは、子供が補助輪を使って自転車に乗るように、アイデア出しをしっかりサポートします！
                    </p>
                </div>
            </div>
