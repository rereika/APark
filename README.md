...
2. [開発の背景、思い](#開発の背景、思い)
   ...
   - [どんな課題解決をどう解決したのか](#どんな課題解決をどう解決したのか)
   - [解説記事](#解説記事)
3. [使用技術](#使用技術)
4. [ER図](#ER図)
5. [システム構成図](#システム構成図)
...
### プロダクト概要
* アプレンティスのカリキュラムに沿った形式で、アイデアを分析・可視化できます。
* AIがテキストベースでフィードバックを提供します。
* 先輩や後輩のアイデアを簡単に参考にできます。
...
アプレンティスでは、チーム開発や個人開発を行う際にテーマ（「自分たちの役に立つものを開発せよ」など）は提供されるものの、 具体的なアイデアは自分たちで考える 必要があります。<br>
その過程で、「良いアイデア」に仕上げる難しさ に直面しました。<br>
...
→ セレクトボックスで簡易的にアイデアの検索ができる！<br><br>
- 先輩・後輩の繋がる場がない<br>
